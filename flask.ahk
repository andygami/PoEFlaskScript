...
2::
{
	...
	;send, q ;simulates the keypress of the 1 button. If you use another button, change it!
	...
	sleep, %delay5%
	send, w ;simulates the keypress of the 5 button. If you use another button, change it!	
	
	sleep, %delay5%
	send, e ;simulates the keypress of the 5 button. If you use another button, change it!
	
	sleep, %delay5%
	send, r ;simulates the keypress of the 5 button. If you use another button, change it!
